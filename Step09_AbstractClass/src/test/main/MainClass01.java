...
public class MainClass01 {
	public static void main(String[] args) {
		...
		Weapon w1 = null; // data type 의 역할은 할 수가 있다.
		// w1.attack(); // NullPointException 발생 (w1 안에 참조값이 없음으로)
		
		// Weapon 추상 클래스를 상속 받은 MyWeapon 클래스로 객체를 생성해서 Weapon type 의 참조값 얻어내기
